...
COMPILER_RT_DIR = $(LOCAL_PATH)../dependencies/bpf-tools/rust/lib/rustlib/sbf-solana-solana/lib
...
# BPF_C_FLAGS := $(filter-out -ffunction-sections,$(BPF_C_FLAGS)) \
# BPF_C_FLAGS := $(filter-out -fdata-sections,$(BPF_C_FLAGS)) \
